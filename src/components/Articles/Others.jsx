    ...
    <div className='note'>
      {articleContent.map((item) => (
        <div key={item.id} className="note-header">
          {item.id === "4" && (
            <div>
              <div className="note4-header-img"></div>
              <div className="note4-header-txt container shadow">
                <h1>{item.title}</h1>
              </div>
            </div>
          )}
      ...
      <div className='note-article' style={{ background: "#003e54", color: "#fff" }}>
            ...
            {item.id === "2" && (
              <div className='page-comment-col'>
                ...
                <div className="comment-text note-comment-text">
                  <p style={{ borderColor: "#003e54", color: "#003e54" }}>
                    {item.content}
                    <span>
