            ...
            <Form className="form">
                ...
                <div className="credit-card-info--form">
                    <div className="input_container">
                        ...
                        <input id="password_field" className="input_field" type="text" name="input-name" title="Input_title" placeholder="Enter your full name" />
                    </div>
                    <div className="input_container">
                        <label htmlFor="password_field" className="input_label">Card Number</label>
                        <input id="password_field" className="input_field" type="number" name="input-name" title="Input_title" placeholder="0000 0000 0000 0000" />
                    </div>
                    <div className="input_container">
